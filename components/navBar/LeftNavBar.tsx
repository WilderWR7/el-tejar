...
export default function LeftNavBar({children}:Props ) {
        ...
        <Box sx={{ display: "flex" }}>
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <List style={{ backgroundColor: "#045044" }}>
                    {[
                        { text: "Registra Jugador", link: "/" },
                        { text: "Credenciales", link: "/print" },
                        { text: "Busca Jugador", link: "/searchplayer" },
                        { text: "Partido", link: "/game" },
                    ].map((data, index) => (
                        <ListItem
                            key={data.link}
                            disablePadding
